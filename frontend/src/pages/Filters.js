                ...
                <div className="form-control">
                    ...
                    <select name="company" value={company} onChange={updateFilters}>
                        {companies.map((comp, index) => {
                            return <option key={index} value={comp} onChange={updateFilters}>{comp}</option>
                        })}
                    </select>
                </div>
                <div className="form-control">
                    ...
                    {colors.map((col, index) => {
                        if (col === "all") {
                            return ( 
                            <button key={index} name="color" onClick={updateFilters} data-color="all" className={`${col === "all" ? "all-btn active" : "all-btn"}`}>{col}</button>
                            )}
                        return <button key={index} name="color" style={{background: col}} className={`${color === col ? "color-btn active" : "color-btn"}`}
